    ...
    <div className="window">
      ...
      <section className="cv">
        ...
        <p className="cv__text">
          ...
          <span className="cv__highlight"> 9th of March, 2025</span>.
        </p>
        <p className="cv__text cv__text--disclaimer">
          Your email address will not be retained, sold, or utilised for
          unwanted marketing communications. This notification indicates the
          download of my CV via email, and as part of my commitment to privacy,
          this data will be deleted within 30 days. Thank you for your
          understanding.
        </p>
        <form
